...
public class DdzGameRoomsActivity extends AutoLayoutActivity implements View.OnClickListener {

    // 图片封装为一个数组
    private int[] icon = {R.mipmap.icon_landlord, R.mipmap.icon_landlord};
    private String[] iconName = {"房间001", "房间002"};
...
//                setTitle((String)item.get("ItemText"));
                switch (i) {
                    case 0:
                        startActivity(new Intent(DdzGameRoomsActivity.this, DdzGamePlayActivity.class));
                        break;
                }
            }
        });
